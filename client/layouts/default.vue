                ...
                <b-collapse
                    ...
                    <b-navbar-nav class="mx-auto">
                        ...
                        <b-nav-item-dropdown
                            ...
                            text="Tokens">
                            <b-dropdown-item :to="{name: 'tokens'}">ABCH20 Tokens</b-dropdown-item>
                            <b-dropdown-item :to="{name: 'tokentxs'}">ABCH20 Transfers</b-dropdown-item>
                            <b-dropdown-item :to="{name: 'tokens-nft'}">ABCH721 Tokens</b-dropdown-item>
                            <b-dropdown-item :to="{name: 'tokentxs-nft'}">ABCH721 Transfers</b-dropdown-item>
                        </b-nav-item-dropdown>
                        <b-nav-item-dropdown
                            text="Blocks">
                ...
                <div class="row">
                    ...
                    <b-col
                        ...
                        <ul class="list-inline tomo-footer__social">
                            ...
                            <li class="list-inline-item">
                                <a
                                    href="https://www.facebook.com/jldevelop"
                                    target="_blank">
                            ...
                            <li class="list-inline-item">
                                <a
                                    href="https://twitter.com/jldblockchain"
                                    target="_blank">
